...
Zondy.Service.HttpRequest = OpenLayers.Class({
    ...
    */
    ajax: function (restUrl, dataObject, onSuccess, type, contentType, resultFormat, async, onError, options) {
    ...
    ajaxForProxy: function (restUrl, dataObject, onSuccess, type, contentType, dataType, onError, options, async) {
    ...
    ajaxNormal: function (restUrl, dataObject, onSuccess, type, contentType, dataType, onError, options, async) {
